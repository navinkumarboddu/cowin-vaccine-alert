...
public class SelCenters {
	private String address_l;

	private String pincode;

	private SelCalenderByPinSessions[] sessions;
	...
	public SelCalenderByPinSessions[] getSessions() {
		return sessions;
	}

	public void setSessions(SelCalenderByPinSessions[] sessions) {
		this.sessions = sessions;
	}

	@Override
	public String toString() {
		return "SelCenters [address_l=" + address_l + ", pincode=" + pincode + ", sessions=" + Arrays.toString(sessions)
				+ ", address=" + address + ", vaccine_fees=" + Arrays.toString(vaccine_fees) + ", district_name_l="
				+ district_name_l + ", name_l=" + name_l + ", fee_type=" + fee_type + ", state_name_l=" + state_name_l
				+ ", long=" + longe + ", district_name=" + district_name + ", block_name=" + block_name
				+ ", block_name_l=" + block_name_l + ", center_id=" + center_id + ", state_name=" + state_name
				+ ", name=" + name + ", from=" + from + ", to=" + to + ", lat=" + lat + "]";
	}
